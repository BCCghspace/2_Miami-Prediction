...
#       mutate(Legend = "Unioned Buffer"))
 ...
 train <-
   ...
   mutate(
     ...
     #green space
     greenNN1 = nn_function(st_c(st_centroid(train)), st_c(green), 1),
...
```{r correlation}
 #cor test
 cor.test(train$distWater, train$SalePrice, method = "pearson")
